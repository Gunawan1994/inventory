...
var inventory_v1_core_order_order_pb = require('../../../../inventory/v1/core/order/order_pb.js');
...
function serialize_CancelOrderRequest(arg) {
  if (!(arg instanceof inventory_v1_core_order_order_pb.CancelOrderRequest)) {
...
function deserialize_CancelOrderRequest(buffer_arg) {
  return inventory_v1_core_order_order_pb.CancelOrderRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_CancelOrderResponse(arg) {
  if (!(arg instanceof inventory_v1_core_order_order_pb.CancelOrderResponse)) {
...
function deserialize_CancelOrderResponse(buffer_arg) {
  return inventory_v1_core_order_order_pb.CancelOrderResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_CreateOrderRequest(arg) {
  if (!(arg instanceof inventory_v1_core_order_order_pb.CreateOrderRequest)) {
...
function deserialize_CreateOrderRequest(buffer_arg) {
  return inventory_v1_core_order_order_pb.CreateOrderRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_CreateOrderResponse(arg) {
  if (!(arg instanceof inventory_v1_core_order_order_pb.CreateOrderResponse)) {
...
function deserialize_CreateOrderResponse(buffer_arg) {
  return inventory_v1_core_order_order_pb.CreateOrderResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_GetOrderRequest(arg) {
  if (!(arg instanceof inventory_v1_core_order_order_pb.GetOrderRequest)) {
...
function deserialize_GetOrderRequest(buffer_arg) {
  return inventory_v1_core_order_order_pb.GetOrderRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_GetOrderResponse(arg) {
  if (!(arg instanceof inventory_v1_core_order_order_pb.GetOrderResponse)) {
...
function deserialize_GetOrderResponse(buffer_arg) {
  return inventory_v1_core_order_order_pb.GetOrderResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var OrderServiceService = exports.OrderServiceService = {
  createOrder: {
    ...
    requestType: inventory_v1_core_order_order_pb.CreateOrderRequest,
    responseType: inventory_v1_core_order_order_pb.CreateOrderResponse,
  ...
  cancelOrder: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: inventory_v1_core_order_order_pb.CancelOrderRequest,
    responseType: inventory_v1_core_order_order_pb.CancelOrderResponse,
  ...
  getOrder: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: inventory_v1_core_order_order_pb.GetOrderRequest,
    responseType: inventory_v1_core_order_order_pb.GetOrderResponse,
