...
var inventory_v1_core_inventory_inventory_pb = require('../../../../inventory/v1/core/inventory/inventory_pb.js');
var inventory_v1_global_meta_meta_pb = require('../../../../inventory/v1/global/meta/meta_pb.js');

function serialize_CheckStockRequest(arg) {
  if (!(arg instanceof inventory_v1_core_inventory_inventory_pb.CheckStockRequest)) {
...
function deserialize_CheckStockRequest(buffer_arg) {
  return inventory_v1_core_inventory_inventory_pb.CheckStockRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_CheckStockResponse(arg) {
  if (!(arg instanceof inventory_v1_core_inventory_inventory_pb.CheckStockResponse)) {
...
function deserialize_CheckStockResponse(buffer_arg) {
  return inventory_v1_core_inventory_inventory_pb.CheckStockResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_ReleaseStockRequest(arg) {
  if (!(arg instanceof inventory_v1_core_inventory_inventory_pb.ReleaseStockRequest)) {
...
function deserialize_ReleaseStockRequest(buffer_arg) {
  return inventory_v1_core_inventory_inventory_pb.ReleaseStockRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_ReleaseStockResponse(arg) {
  if (!(arg instanceof inventory_v1_core_inventory_inventory_pb.ReleaseStockResponse)) {
...
function deserialize_ReleaseStockResponse(buffer_arg) {
  return inventory_v1_core_inventory_inventory_pb.ReleaseStockResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_ReserveStockRequest(arg) {
  if (!(arg instanceof inventory_v1_core_inventory_inventory_pb.ReserveStockRequest)) {
...
function deserialize_ReserveStockRequest(buffer_arg) {
  return inventory_v1_core_inventory_inventory_pb.ReserveStockRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_ReserveStockResponse(arg) {
  if (!(arg instanceof inventory_v1_core_inventory_inventory_pb.ReserveStockResponse)) {
...
function deserialize_ReserveStockResponse(buffer_arg) {
  return inventory_v1_core_inventory_inventory_pb.ReserveStockResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var InventoryServiceService = exports.InventoryServiceService = {
  checkStock: {
    ...
    requestType: inventory_v1_core_inventory_inventory_pb.CheckStockRequest,
    responseType: inventory_v1_core_inventory_inventory_pb.CheckStockResponse,
  ...
  reserveStock: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: inventory_v1_core_inventory_inventory_pb.ReserveStockRequest,
    responseType: inventory_v1_core_inventory_inventory_pb.ReserveStockResponse,
  ...
  releaseStock: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: inventory_v1_core_inventory_inventory_pb.ReleaseStockRequest,
    responseType: inventory_v1_core_inventory_inventory_pb.ReleaseStockResponse,
